...
| Scenario       | Flexily Classic | Flexily Zero-alloc |
| -------------- | --------------- | ------------------ |
| Flat 500 nodes | 1x              | 1.75-2x faster     |
| Deep 50 levels | 1x              | ~1x (similar)      |
| Kanban TUI     | 1x              | ~1.1x faster       |

For Flexily-vs-Yoga numbers, see [Performance](/guide/performance) — the
benchmarks there are the maintained source of truth.
