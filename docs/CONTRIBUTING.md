...
- **Node.js** >= 23.6 for development (native TS type-stripping); the published package supports Node >= 18
- **TypeScript** >= 5.7
...
├── layout-zero.ts  # Layout algorithm (~2700 lines, hot path)
...
1. **Run the full test suite** (`bun test`) — all 1774 tests must pass
