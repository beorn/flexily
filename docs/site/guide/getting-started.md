...
**Classic**: Allocates temporary objects during layout. Easier to read and debug. Use this when stepping through the algorithm.
...
- [Algorithm](/guide/algorithm) -- How the layout algorithm works
- [Performance](/guide/performance) -- Benchmarks and methodology
- [Yoga Comparison](/guide/yoga-comparison) -- Feature comparison with Yoga
