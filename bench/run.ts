#!/usr/bin/env bun
/**
 * Flexily Layout Benchmarks - Standalone Runner
 *
...
console.log("# Flexily Layout Benchmarks")
console.log("")
...
console.log("## Summary")
console.log("")
console.log("For terminal UIs (typically <500 nodes), Flexily handles layout in <1ms.")
